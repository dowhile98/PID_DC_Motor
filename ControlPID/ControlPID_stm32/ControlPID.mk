...
#                        of executable (1/0)?
MODEL                = ControlPID
MODULES              = ControlPID_EXTI.c ControlPID_TIM.c ControlPID_USART.c main.c stm32xxxx_it.c
MODULES_OBJ          = ControlPID_EXTI.obj ControlPID_TIM.obj ControlPID_USART.obj main.obj stm32xxxx_it.obj 
MAKEFILE             = ControlPID.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ControlPID_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -ID:/TRABAJO/UMAKER/TALLERES/TALLER RAS UNI/PID_DC_Motor/ControlPID  -ID:/TRABAJO/UMAKER/TALLERES/TALLER RAS UNI/PID_DC_Motor/ControlPID/ControlPID_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -IC:/MATLAB/STM32-MAT/STM32/addSrc/inc 
