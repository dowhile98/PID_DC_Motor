...
static uint8_t USART2_TxDataBuffer[512];
...
void USART2_Tx_Initialization(void)
{
  ...
  USART2_TxConf.buffSize = 512;
  USART2_TxConf.pTx_BuffStart = &USART2_TxDataBuffer[0];
  USART2_TxConf.pTx_BuffEnd = &USART2_TxDataBuffer[512];
